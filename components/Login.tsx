...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    const users: Record<string, { password: string; email: string; name: string; role: string }> = {
      'admin': { password: 'Admin123', email: 'admin@prasama.com', name: 'Admin', role: 'ADMIN' },
      'salesprasama@gmail.com': { password: 'Madura12', email: 'salesprasama@gmail.com', name: 'Cashier 1', role: 'ADMIN' },
      'madupathirana95@gmail.com': { password: 'Madura12', email: 'madupathirana95@gmail.com', name: 'Cashier 2', role: 'CASHIER' }
    };
    ...
    onLogin({
      userId: username === 'madupathirana95@gmail.com' ? 'cashier-2' : (username === 'admin' ? 'admin' : 'cashier-1'),
      name: user.name,
      branch: "Local Node",
